...
def _generate_twinning_base(structure: Atoms, plane: np.ndarray, shear: np.ndarray) -> Atoms:
...
def _generate_fcc_twinning(structure: Atoms, twin_plane: str = '{111}') -> Atoms:
    ...
    plane = np.array([1, 1, 1])
    shear = np.array([1, 1, 2])
    return _generate_twinning_base(structure, plane, shear)


def _generate_bcc_twinning(structure: Atoms, twin_plane: str = '{112}') -> Atoms:
...
def _generate_hcp_twinning(structure: Atoms, twin_plane: str = '{10-12}') -> Atoms:
...
def generate_twinning(structure: Atoms,
    ...
    if crystal_type == 'fcc':
        return _generate_fcc_twinning(structure, twin_plane or '{111}')
    elif crystal_type == 'bcc':
        return _generate_bcc_twinning(structure, twin_plane or '{112}')
    elif crystal_type == 'hcp':
        return _generate_hcp_twinning(structure, twin_plane or '{1012}')
    elif crystal_type == 'diamond':
        return _generate_diamond_twinning(structure, twin_plane or '{111}')
    elif crystal_type == 'tetragonal':
        return _generate_tetragonal_twinning(structure, twin_plane or '{101}')
    else:
        raise ValueError(
...
def _generate_diamond_twinning(structure: Atoms, twin_plane: str = '{111}') -> Atoms:
...
def _generate_tetragonal_twinning(structure: Atoms, twin_plane: str = '{101}') -> Atoms:
